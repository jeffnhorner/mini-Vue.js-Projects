<template>
  <div class="content">
    <h3>RGB{{ randColor }} Color Game</h3>
    <div class="header">
...
export default {
  ...
  methods: {
    /* we're doing a few things here: we're grabbing all of the colorCards and also using the array from the numberOfSquares method. First, we're looping over all of the colorCards. We then are looking to see how many items the array contains. If there are items in the array, it will set display:block on the colorCards based upon the numColorCards defined in the button click events (easyGame, hardGame) */
    setupColorCards() {
      this.colors = this.numberOfSquares(this.numColorCards);
  ...
  mounted() {
    /* defines colorCards when the component mounts (loads). Prior to this, the array of color-cards wasn't
    created until the user clicked a game mode button*/
